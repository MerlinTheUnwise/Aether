...
5. **[Patterns Cookbook](patterns.md)** — Complete IR examples for 14 common scenarios. Copy and adapt these — don't generate from scratch when a pattern exists.
...
| Run with real implementations | [Language Guide](language-guide.md) → Real Execution |
...
| `patterns.md` | 14 complete IR examples | Copy-and-adapt cookbook |
| `cli-reference.md` | All 31 CLI commands | Tool usage reference |
